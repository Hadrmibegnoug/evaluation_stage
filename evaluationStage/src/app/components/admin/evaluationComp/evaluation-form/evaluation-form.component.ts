...
export class EvaluationFormComponent {
  ...
  constructor(private fb: FormBuilder, private http: HttpClient, private evaluationService: EvaluationService, private router: Router) {
  ...
  submit() {
    ...
    this.evaluationService.createEvaluation(payload).subscribe(
      (response) => {
        ...
        this.goToHome(); // Rediriger vers la page des tuteurs après la création
